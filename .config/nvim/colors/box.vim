...
hi GitSignsAdd guifg=#55cc55 guibg=NONE
hi GitSignsChange guifg=#e5c07b guibg=NONE
hi GitSignsDelete guifg=#DD5555 guibg=NONE
hi TelescopeSelection guibg=#303030
hi MiniJump2dSpot guibg=NONE guifg=#55cc55
hi MiniJump2dSpotAhead guibg=NONE guifg=#55cc55
hi MiniJump guibg=#aa5555 guifg=NONE
hi BlinkCmpKind guibg=NONE guifg=#D68F3A
hi BlinkCmpLabelDetail guibg=NONE guifg=#928374
hi BlinkCmpLabelDescription guibg=NONE guifg=#928374
hi MiniFilesNormal guibg=NONE guifg=#c2b3a4
...
hi Method guifg=#3399aa
hi Struct guifg=#a11aaa
hi WinSeparator guibg=NONE

hi Normal guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
hi CursorLineNr guifg=#fabd2f guibg=NONE gui=bold cterm=bold
...
hi Pmenu guifg=#83a598 guibg=NONE gui=NONE cterm=NONE
hi PmenuSbar guifg=NONE guibg=NONE gui=NONE cterm=NONE
hi PmenuSel guifg=#000000 guibg=#ffffff gui=bold cterm=bold
...
hi PmenuExtra guifg=#a89984 guibg=NONE gui=NONE cterm=NONE
hi PmenuExtraSel guifg=#303030 guibg=#83a598 gui=NONE cterm=NONE
hi PmenuMatch guifg=#b16286 guibg=NONE gui=NONE cterm=NONE
hi PmenuMatchSel guifg=#b16286 guibg=#83a598 gui=bold cterm=bold
hi SpecialKey guifg=#928374 guibg=NONE gui=NONE cterm=NONE
hi StatusLine guifg=#000000 guibg=#000000 gui=bold,reverse cterm=bold,reverse
hi StatusLineNC guifg=#408080 guibg=NONE gui=reverse cterm=reverse
hi TabLine guifg=#a89984 guibg=NONE gui=NONE cterm=NONE
hi TabLineFill guifg=#ebdbb2 guibg=NONE gui=NONE cterm=NONE
hi TabLineSel guifg=#fe8019 guibg=NONE gui=bold cterm=bold
...
hi Conceal guifg=#90e0a0 guibg=NONE gui=NONE cterm=NONE
hi Cursor guifg=NONE guibg=#fbf1c7 gui=NONE cterm=NONE
hi DiffAdd guifg=#00a0b0 guibg=NONE gui=reverse cterm=reverse
...
hi Directory guifg=#00a0b0 guibg=NONE gui=bold cterm=bold
...
hi Title guifg=#00a0b0 guibg=NONE gui=bold cterm=bold
...
hi Function guifg=#00a0b0 guibg=NONE gui=bold cterm=bold
...
hi String guifg=#00a0b0 guibg=NONE gui=NONE cterm=NONE
...
hi CursorIM guifg=NONE guibg=#fbf1c7 gui=NONE cterm=NONE
