...
function! gitgutter#highlight#define_highlights() abort
  ...
  execute "highlight GitGutterAddInvisible    guifg=bg guibg=" . guibg . " ctermfg=46 ctermbg=" . ctermbg
  execute "highlight GitGutterChangeInvisible guifg=bg guibg=" . guibg . " ctermfg=46 ctermbg=" . ctermbg
  execute "highlight GitGutterDeleteInvisible guifg=bg guibg=" . guibg . " ctermfg=46 ctermbg=" . ctermbg
  highlight default link GitGutterChangeDeleteInvisible GitGutterChangeInvisible

  " When they are visible.
  for type in ["Add", "Change", "Delete"]
    execute "highlight GitGutter".type." guibg=".guibg." ctermbg=".ctermbg." ctermfg=46"
  endfor

  if hlexists("GitGutterChangeDelete") && g:gitgutter_set_sign_backgrounds
    execute "highlight GitGutterChangeDelete guibg=".guibg." ctermbg=".ctermbg." ctermfg=46"
  endif

  highlight default link GitGutterChangeDelete GitGutterChange

  " Highlights used for the whole line.
  execute "highlight GitGutterAddLine          ctermfg=46"
  execute "highlight GitGutterChangeLine       ctermfg=46"
  execute "highlight GitGutterDeleteLine       ctermfg=46"
  execute "highlight GitGutterChangeDeleteLine ctermfg=46"
  execute "highlight GitGutterAddLineNr         ctermfg=46"
  execute "highlight GitGutterChangeLineNr      ctermfg=46"
  execute "highlight GitGutterDeleteLineNr      ctermfg=46"
  execute "highlight GitGutterChangeDeleteLineNr ctermfg=46"
  ...
  execute "highlight default GitGutterAddIntraLine    ctermfg=46 cterm=reverse"
  execute "highlight default GitGutterDeleteIntraLine  ctermfg=46 cterm=reverse"
  ...
  for [dtype,type] in [['Added','Add'], ['Changed','Change'], ['Removed','Delete']]
    if !hlexists('diff'.dtype)
      execute "highlight diff".dtype." ctermfg=46 guibg=NONE ctermbg=NONE"
    endif
  endfor
endfunction
